...
class MediaPlayerListener implements MediaPlayer.OnPreparedListener,
	...
	private final MediaPlayerBridge mMediaPlayerBrige;

    private MediaPlayerListener(long nativeMediaPlayerListener, Context context, MediaPlayerBridge mediaPlayerBrige) {
        mNativeMediaPlayerListener = nativeMediaPlayerListener;
        mContext = context;
		mMediaPlayerBrige = mediaPlayerBrige;
    }
    ...
    public void onPrepared(MediaPlayer mp) {
        if (mMediaPlayerBrige.isPendingPause()) {
			mMediaPlayerBrige.pause();
			mMediaPlayerBrige.clearPendingPause();
			return;
        }
    ...
    private static MediaPlayerListener create(int nativeMediaPlayerListener,
        ...
        final MediaPlayerListener listener =
                new MediaPlayerListener(nativeMediaPlayerListener, context, mediaPlayerBridge);
