...
public class ContentViewCore
	...
	public void pauseVideo() {
		nativePauseVideo(mNativeContentViewCore);
	}

	public void notifyEndVideo(int playID) {
		nativeNotifyEndVideo(mNativeContentViewCore, playID);
	}
	...
	@CalledByNative
	private void notifyVideoUrl(String url, int playerID) {
	    getContentViewClient().notifyVideoUrl(url, playerID);
	}
	...
	private native void nativePauseVideo(long nativeContentViewCoreImpl);

	private native void nativeNotifyEndVideo(long nativeContentViewCoreImpl, int playID);
}
